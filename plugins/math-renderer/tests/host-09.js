...
const code = buildSync({
  stdin: { contents: 'export * from "./agent-stream/presentation"; export * from "./plugins/timeline/model"; export * from "./agent-stream/chat-find/model";', resolveDir: fixtures },
...
export const { createStreamPresentation, transformTimelineItem, ChatFindModel } = module.exports;
